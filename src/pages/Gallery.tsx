...
const images = [
  ...
  { src: 'images/Gallery Pic 2.jpg', alt: 'Gallery moment 2', caption: '1 on 1 Mentoring', description: 'Personal guidance and individual development through direct mentorship' },
  { src: 'images/Gallery Pic 4.jpg', alt: 'Gallery moment 4', caption: 'Team Building', description: 'Building strong relationships and teamwork skills through collaborative activities' },
